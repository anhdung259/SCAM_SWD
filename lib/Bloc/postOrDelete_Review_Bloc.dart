...
class PostReviewBloc {
  ...
  Future<dynamic> deleteReview(int reviewAnswer) async {
    var response =
        await http.delete(mainUrl + "?UserReviewID=$reviewAnswer", headers: {
      "Accept": "application/json",
      "content-type": "application/json",
      'Authorization': 'Bearer ${_storage.getItem('token')}',
    });
...
final postOrDeleteReviewBloc = PostReviewBloc();
